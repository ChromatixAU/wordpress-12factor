 ...
 * Build: http://modernizr.com/download/#-backgroundsize-borderradius-boxshadow-flexbox-hsla-multiplebgs-opacity-rgba-cssanimations-csstransforms-csstransforms3d-csstransitions-video-input-inputtypes-inlinesvg-svg-svgclippaths-touch-shiv-mq-cssclasses-addtest-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-css_backgroundposition_shorthand-css_backgroundposition_xy-css_backgroundsizecover-css_calc-css_mediaqueries-css_positionsticky-forms_placeholder-forms_validation-ie8compat-svg_filters-vibration-load-cssclassprefix:mod!
 */
;
...
Modernizr.addTest('mediaqueries', Modernizr.mq('only all'));// Method of allowing calculated values for length units, i.e. width: calc(100%-3em) http://caniuse.com/#search=calc
// By @calvein
